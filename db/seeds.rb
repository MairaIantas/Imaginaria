...
#
# Customer.create(first_name: 'guest', last_name: 'guest', email: 'guest@guest')
#
#
...
#
#
# prod = home_decor.products.build(name: 'Alarm Clock',
#                                 description:'Dinamite alarm clock',
#                                 price: 39.90,
#                                 qty: 10)
#
# prod.save
#
# prod = home_decor.products.build(name: 'Mini Tree',
#                                 description:'Mini light tree',
#                                 price: 59.90,
#                                 qty: 10)
#
# prod.save
...
# prod.save
#
# prod = electronics.products.build(name: 'Darth Vader Speaker',
#                                 description:'Darth Vader Speaker',
#                                 price: 99.90,
#                                 qty: 20)
# prod.save
# prod = electronics.products.build(name: 'Vintage Clock',
